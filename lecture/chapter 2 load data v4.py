...
''' 
housing = strat_train_set.drop("median_house_value", axis=1) #axis=1 says drop a column
...
print(imputer.statistics_) #The output from lines 125 and 126 should be the same
